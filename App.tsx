...
const openWeatherKey = `d2bfac6dbd9ab75d9043bdfdb3c9435d`;
...
const App = () => {
  ...
  const loadForecast = async () => {
    ...
    let location = await Location.getCurrentPositionAsync({enableHighAccuracy: true} as any);
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        {forecast.daily.slice(0,5).map((d: any) => { //Only want the next 5 days
